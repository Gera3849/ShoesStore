...
document.getElementById('user_product_pagination').innerHTML = createPagination(pages, currentPage);
...
function createPagination(pages, page) {
    ...
    document.getElementById('user_product_pagination').innerHTML = str;
    return str;
}

function showProducts(pageNum) {
    window.location.href = `/dashboard/user/products/${category}/${pageNum}`;
}
